...
public class CST {
    ...
    public static final int ADD_LIMIT = 1000;
    public static final int MINUS_LIMIT = 1000;
    public static final int MULTIPLE_LIMIT = 12;
    public static final int ADD_GOAL = 18;
